...
def compute_accuracy(model, input_data, input_target, mini_batch_size):
    ...
    model.eval() #imporzant for dropout!
    nb_errors = 0
...
def name():
    return "ResNet with weight sharing"


def main(use_batch_normalization=False, use_dropout=False):
    nb_samples = 1000
    mini_batch_size = 100
    nb_models = 10
    training_accuracies =[] 
    test_accuracies = []
    print("use batch norm", use_batch_normalization)
