...
class SiameseClass(nn.Module):
    ...
    def __init__(self, use_batch_normalization):
        ...
        """
        super(SiameseClass, self).__init__()
...
def main(use_batch_normalization=True, use_dropout=False):
    ...
    for seed in range(nb_models):
        print("Siamese model number", seed + 1)
        ...
        model = SiameseClass(use_batch_normalization)
